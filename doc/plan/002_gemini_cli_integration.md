...
- [ ] Task: Backend - Implement `open_directory` and `open_terminal` commands.
...
- [ ] Task: Backend - Implement `run_shell_command` with streaming.
...
- [ ] Task: Frontend - Create `CommandLogViewer.vue`.
...
- [ ] Checkpoint: capable of running a dummy command (e.g., `ls -la`) and seeing output in the frontend modal.
